<fieldset>
    <div class="form-group">
        <label for="question">Question *</label>
          <input type="text" name="question" value="<?php echo htmlspecialchars($edit ? $question['question'] : '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="Question" class="form-control" required="required" id = "question" >
    </div> 
